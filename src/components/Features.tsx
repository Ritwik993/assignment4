...
const Features = () => {
  return (
    <div className='mt-[50px] relative flex flex-col items-center justify-center font-montserrat'>
        ...
        <p className='absolute  top-[400px] font-medium md:text-[58px] text-[32px] text-[#F0F0F0]  font-montserrat border border-white w-full text-center md:w-[905px]'>World’s most accurate email  verifier and validator online</p>
        </div>
    </div>
  )
}
